...
dotenv.config();
const {adminModel, Imagemodel} = require('../Module/adminModel'); // Added 'const'
...
const urlUpload = async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ message: 'Failed to save image URL', error: err.message });
  }
};

module.exports = { login ,upload,urlUpload};  